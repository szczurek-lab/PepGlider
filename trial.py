...
def run_epoch_iwae(
    ...
    for batch, labels, physchem, attributes_input in dataloader: 
        ...
        print(f'minimum mu value = {mu.min().item()}')
        print(f'maximum mu value = {mu.max().item()}')
        print(f'minimum std value = {std.min().item()}')
        print(f'maximum std value = {std.max().item()}')
        ...
        for _ in range(K):
            ...
            print(f'minimum z value = {z.min().item()}')
            print(f'maximum z value = {z.max().item()}')
